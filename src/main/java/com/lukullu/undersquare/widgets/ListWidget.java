...
public class ListWidget extends Widget implements ProcessingClass {
    ...
    public ListWidget(Vector2 _pos, Vector2 _dim, int _cornerBL, int _cornerBR, int _cornerTL, int _cornerTR){ super(_pos, _dim, _cornerBL, _cornerBR, _cornerTL, _cornerTR); }
