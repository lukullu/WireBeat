...
public class Potion extends Item{
    ...
    public static final Potion SMALL_POTION  = new Potion("Small Potion",  Color.magenta.brighter(), 100);
    public static final Potion MEDIUM_POTION = new Potion("Medium Potion", Color.magenta,            200);
    public static final Potion LARGE_POTION  = new Potion("Large Potion",  Color.magenta.darker(),   400);
